...
- (void)initPage
{
  ...
  // 顶部监控对象名称
  self.monitorNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 75, (width - 30) / 3, 30)];
  ...
  // 从业人员
  self.peopleNameLabel = [[UILabel alloc] initWithFrame:CGRectMake((width - 30) / 3 + 15, 75, (width - 30) / 3, 30)];
...
//    UIImage *image = [UIImage imageNamed:value];
    ...
    self.uploadIdCardBtn.backgroundColor = [UIColor colorWithRed:51/255.0 green:80/255.0 blue:1 alpha:1];
...
//    UIImage *image = [UIImage imageNamed:value];
    ...
    self.uploadDriverLicenseBtn.backgroundColor = [UIColor colorWithRed:51/255.0 green:80/255.0 blue:1 alpha:1];
...
//    UIImage *image = [UIImage imageNamed:value];
    ...
    self.uploadQualificationCertificateBtn.backgroundColor = [UIColor colorWithRed:51/255.0 green:80/255.0 blue:1 alpha:1];
...
-(void)uploadInfoEvent:(UIButton *)btn
{
  ...
  UIImage *image = nil;
  if (index == 1) {
    image = [[self.idCardInfoData objectAtIndex:1] objectForKey:@"value"];
  } else if (index == 2) {
    image = [[self.driverLicenseInfoData objectAtIndex:1] objectForKey:@"value"];
  } else if (index == 3) {
    image = [[self.qualificationCertificateInfoData objectAtIndex:1] objectForKey:@"value"];
  }
  if (image != nil) {
                                           ...
                                           if (statusCode == 200 && success == YES) {
                                             ...
                                             if (data.count > 0) {
                                               ...
                                               if ([flag isEqualToString:@"1"]) {
                                                 ...
                                                 dispatch_async(dispatch_get_main_queue(), ^{
                                                   [[ToastView shareInstance] makeToast:@"该从业人员已存在，请确认" duration:2.0];
                                                 });
                                               }
                                             }
