...
- (void)addGenderPickerView
{
  ...
  [btnOK setTitleColor:[UIColor colorWithRed:51/255.0 green:80/255.0 blue:1 alpha:1] forState:UIControlStateNormal];
  ...
  [btnCancel setTitleColor:[UIColor colorWithRed:51/255.0 green:80/255.0 blue:1 alpha:1] forState:UIControlStateNormal];
...
- (void)uploadIdCard
{
  UIImage *image = [[self.peopleCardInfoData objectAtIndex:2] objectForKey:@"value"];
