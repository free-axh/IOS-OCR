...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  if (indexPath.row == 0) {
    ...
    UILabel *nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(15, 0, self.view.frame.size.width, 44)];
...
{
  UIImage *image = [[self.transportInfoData objectAtIndex:2] objectForKey:@"value"];
